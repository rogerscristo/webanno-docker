...
RUN cp /etc/apt/sources.list /etc/apt/sources.list.d.bak
RUN echo "deb http://security.ubuntu.com/ubuntu precise-security main universe" | tee -a /etc/apt/sources.d.list
